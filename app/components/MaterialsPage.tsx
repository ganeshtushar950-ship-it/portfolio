...
import { Image as ImageIcon, Video, Plus, BookOpen, FileText, ClipboardList, LayoutGrid, Download, GraduationCap, User } from "lucide-react";
  ...
  const [mediaItems, setMediaItems] = useState<MediaItem[]>([
    {
      ...
      description: "Students learning about hardware components and assembly",
    ...
    },
    {
      ...
      description: "Hands-on programming practice with students",
    ...
    },
    {
      ...
      description: "Teaching software installation and configuration",
    ...
    },
    {
      ...
      description: "Students collaborating on IT troubleshooting task",
    ...
    },
    {
      ...
      description: "Interactive lesson demonstration with visual aids",
      src: "/media/demo.jpg",
    },
    {
      id: "6",
      ...
      description: "Tutorial video on software installation process",
    ...
    },
    {
      ...
      description: "Student case study and practical demonstration video",
    ...
    },
    {
      ...
      description: "Additional student case study and demonstration",
    ...
    },
    {
      ...
      description: "Regular classroom teaching session with students",
    ...
    },
    {
      ...
      description: "IT lab setup with various hardware components",
    ...
    },
    {
      ...
      description: "Students completing practical assessment tasks",
  ...
  const resources = [
    {
      ...
      icon: BookOpen,
      title: "Lesson Plans",
      description: "Structured lesson plans for IT courses including hardware, software, and programming topics.",
      color: "indigo",
    },
    {
      ...
      icon: FileText,
      title: "Syllabus",
      description: "Course syllabus, learning objectives, and curriculum outlines for IT education.",
      color: "purple",
    },
    {
      ...
      icon: ClipboardList,
      title: "Log Sheets",
      description: "Weekly reflections, observations, and progress notes from internship sessions.",
      color: "green",
    },
    {
      ...
      description: "Additional teaching materials, worksheets, and reference documents.",
      color: "blue",
    },
    {
      ...
      icon: Video,
      title: "Videos & Photos",
      description: "Demonstration videos, tutorials, classroom photos, and lab documentation.",
      color: "red",
    },
    {
      ...
      description: "Official signed teaching logs and documentation from internship period.",
      color: "yellow",
    },
    {
      ...
      description: "Mentor feedback, evaluations, and assessment reports from internship.",
      color: "pink",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900">Teaching Materials</h1>
          </div>
        ...
        {/* Teaching Resources - Google Drive Links */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-8">📚 Teaching Resources & Documents</h2>
            ...
            {resources.map((resource, index) => {
              ...
              return (
                <a
                  ...
                  className={`p-4 rounded-lg border-2 hover:shadow-md group transition cursor-pointer ${colorMap[resource.color as keyof typeof colorMap]}`}
                >
                  <Icon className="mb-2 group-hover:animate-bounce" size={24} />
